use aws_sdk_ssm::types::{
    ParameterTier::{Advanced, IntelligentTiering, Standard},
    ParameterType::{SecureString, String as PsString, StringList},
};
    ...
    match app.get_selected_ps_data() {
        SelectedPsMetadata::Data(ps_metadata, _, name) => {
            ...
            let datetime: DateTime<Utc> =
                DateTime::from_timestamp(modified_date.secs(), modified_date.subsec_nanos())
                    .unwrap();
